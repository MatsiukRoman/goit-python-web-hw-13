...
from django.forms import CharField, PasswordInput, TextInput, EmailInput, EmailField

class RegisterForm(UserCreationForm):
    username = CharField(max_length=50, min_length=3, required=True, widget=TextInput(attrs={"class": "form-control"}))
